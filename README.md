Make a WiFi Weather Station With Arduino and the CC3000 chip [![Build Status](https://travis-ci.org/openhomeautomation/wifi-weather-station.svg)](https://travis-ci.org/openhomeautomation/wifi-weather-station)
====================
